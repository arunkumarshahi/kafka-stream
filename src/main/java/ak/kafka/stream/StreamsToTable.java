...
public class StreamsToTable {
    ...
    public Topology buildTopology(Properties envProps) {
        ...
        final Serde<Long> lSerde = Serdes.Long();
...
//        }
        String path="C:\\Personal_docs\\spring\\kafka-stream\\src\\main\\resources\\application.properties";
        final StreamsToTable instance = new StreamsToTable();
        final Properties envProps = instance.loadEnvProperties(path);
